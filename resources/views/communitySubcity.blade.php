...
{{--             <select class=" selectpicker form-control form-control-lg text-left" data-style="btn-outline-secondary " data-size="6">
            ...
            <div class="btn-group">
              ...
              <div class="btn-group dropdown">
                <button type="button" class="btn btn-light dropdown-toggle waves-effect" data-toggle="dropdown" aria-expanded="false">  <b>{{$selected_subcity[0]->subcity_name}} Districts</b><span class="caret"></span> </button>
...
@endif
        ...
        <div class="col-md-7 col-sm-7">
          @include( "maps.".str_replace(' ','_',$selected_subcity[0]->subcity_name)  )
        </div>
        {{-- end of woreda map --}}
          <style type="text/css">
            .index_guide{
