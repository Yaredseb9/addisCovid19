...
class CreateDataTable extends Migration {
	...
	public function up()
	{
		Schema::create('data', function(Blueprint $table)
		{
			...
			$table->string('risk_index_infection')->default('unavailable');
			$table->string('risk_index_hospital')->default('unavailable');
			$table->string('risk_index_death')->default('unavailable');
